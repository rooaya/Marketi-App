...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _validateBeforeForgotPassword() {
    ...
    if (email.isEmpty) {
      showErrorMessage(context, 'Please enter your email to recover password');
      return;
    }
            ...
            decoration: InputDecoration(
              ...
              border: OutlineInputBorder(
                ...
                borderSide: BorderSide(
                  color: _emailFocusNode.hasFocus ? MarketiColors.primaryBlue : MarketiColors.gray300,
                ),
              ),
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(8),
                borderSide: BorderSide(
                  color: _passwordFocusNode.hasFocus ? MarketiColors.primaryBlue : MarketiColors.gray300,
                ),
              ),
              enabledBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(8),
  ...
  BlocConsumer<LoginCubit, LoginState> _buildLoginBtn() {
