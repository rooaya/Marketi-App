...
class _CreateNewPasswordScreenState extends State<CreateNewPasswordScreen> {
  ...
  Future<void> _updateSavedPassword() async {
    ...
    if (prefs.getBool('isLoggedIn') == true && prefs.getString('email') == widget.email) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: _buildCreateNewPasswordForm(),
      ),
    );
  }

  Form _buildCreateNewPasswordForm() {
    return Form(
      key: _formKey,
      child: Column(
        children: [
          ...
          const SizedBox(height: 40),
          _buildBlocConsumerSavePasswordBtn(),
        ],
      ),
    );
  }

  BlocConsumer<CreatepassCubit, CreatepassState> _buildBlocConsumerSavePasswordBtn() {
    return BlocConsumer<CreatepassCubit, CreatepassState>(
